...
- work through a complete work cycle editing one or more documents.
- (Atom users only) open a repository in Atom using the `Open the repository in your external editor` option in GitHub Desktop.
...
## Optional: CSV spreadsheets (4m38s)
...
<img src="../checkboxes.png" style="border:1px solid black">
...
## Optional: The problem of binary files (3m42s)
...
## Optional: Editing .gitignore (5m09s)
...
## Optional: Making, pushing, and viewing a PDF (4m17s)
