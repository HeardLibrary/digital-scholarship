...
While the cell is running, there will be a rotating arc at the left of the cell. To terminate execution, press the square "stop" button inside the circle, or select `Interrupt execution` from the `Runtime` menu.
