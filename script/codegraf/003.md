...
For instructions on installing R and RStudio, see [this page](../../r/install/). However, if you are planning to install the Anaconda distribution, you do not need to go through this step separately. See the following section for more information about Anaconda.
...
Once you have your own notebooks stored, you can select a Recent notebook, or open notebooks on your Google Drive.
