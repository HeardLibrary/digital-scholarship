...
If you just want to get started as quickly as possible, skip this page and go to the [Quickstart guide for running Python in a Colab notebook](../003a) or [Quickstart guide for running R in RStudio Cloud](../003b).
...
If you are learning R and decide not to install Anaconda, to do a stand-alone installation, see [this page](../../r/install/) for instructions. 

Another quick alternative is to use the cloud-based [RStudio Cloud](https://rstudio.cloud/). You can use RStudio there without any installation, although it requires creating an account.
...
[Quickstart on using Jupyter notebooks](../003a/#jupyter-architecture-optional)
