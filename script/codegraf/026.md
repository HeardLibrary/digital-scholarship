...
9. Carry out at t-test of means to determine whether the mean red and blue roach eye response differ significantly. Interpret the results. Make sure the color column is a factor before you run this test.
