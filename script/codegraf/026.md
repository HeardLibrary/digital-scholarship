...
For the rest of the questions, use the cockroach electroretinogram data from [here](https://raw.githubusercontent.com/HeardLibrary/digital-scholarship/master/data/r/red-blue-erg-data.csv).
