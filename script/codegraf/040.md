...
import time
seconds_to_run = 120
measurements_per_second = 12.5 # determined emprically when running full speed, not imposed by sleep statement
...
# Flash LED three times so we know something happened
