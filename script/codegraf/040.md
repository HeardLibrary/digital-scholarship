...
A [Jupyter notebook](https://github.com/HeardLibrary/digital-scholarship/tree/master/code/circuit_python/flight_analysis.ipynb) is available to plot the data stored in the `motion.csv` file. The data collected during the workshop rocket launch is [here](https://github.com/HeardLibrary/digital-scholarship/blob/master/code/circuit_python/motion.csv) and the data collected during a test launch (where the sensors flew out of the end of the payload section!) is [here](https://github.com/HeardLibrary/digital-scholarship/blob/master/code/circuit_python/test_flight_data.csv).
