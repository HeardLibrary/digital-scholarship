...
In either case, click the `X` at the top of the window to close it. **Note:** you won't be able to run either a Python or R shell unless they have already been installed on your computer.
