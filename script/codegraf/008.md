...
There are many additional functions to read and write from other table-like data sources such as tab-separated values files, APIs, and databases. See Section 6.1 of Python for Data Analysis (2nd ed.)  or Chapter 3 of [pandas: powerful Python data analysis toolkit](https://pandas.pydata.org/docs/pandas.pdf) for many options.
