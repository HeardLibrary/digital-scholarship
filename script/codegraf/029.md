...
## Two-factor ANOVA with both effects fixed and interaction (ms)
...
## Mixed model two-factor ANOVA (with blocking) (ms)
...
# Comparing ANOVA with blocking with a paired t-test (ms)
