...
### []() add photo/or video of you connecting the board to the lap top while holding the "red" button
...
### []() add a screenshot of the external board in your pc
...
### []() add a gif/screencapture of you copying and pasting the .UF2 file to the board
...
[this next part might not be needed]()
...
[]() screen capture of you doing exactly this. copying and pasting the two files and then adding them into the board
