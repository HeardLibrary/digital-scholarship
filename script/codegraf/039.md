...
- **WARNING:** Image screenshots and videos are consistent only with the date this documented was created on date of publishing this page. As such, their accurary is dependant on  not be entirely relied on but serve as a general reference,
...
- Begin using pre-constructed code to interact with the microcontroller
...
* As of writing this document (i.e., Feb 16, 2022) the latest version is "adafruit-circuitpython-adafruit_qtpy_rp2040-en_US-7.1.1.uf2"
...
In this step, we'll be connecting the board (i.e., QT Py RP2040) to your computer with a usb cable
...
3\. **While holding onto the** <span style="color:red">red</span> **button**, located in the center, **connect** the other end of **the usb cable to your computer**. After connecting to you computer you can stop holding onto the button.
...
<iframe width="1120" height="630" src="https://www.youtube.com/embed/YtIyRzlqgfg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<iframe width="1120" height="630" src="https://www.youtube.com/embed/5xy2fkHqfXw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
* As of writing this document (i.e., Feb 16, 2022) the latest version is "adafruit-circuitpython-bundle-7.x-mpy-20220216.zip
...
<iframe width="1120" height="630" src="https://www.youtube.com/embed/SRgRb_6I4lY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
We'll do that by copying and pasting the two .mpy files from the adafruit-circuitpython-bundle-7.x-mpy-2022XXXX folder into the CIRCUITPY External Drive

1\. **Open** the **"adafruit-circuitpython-bundle-7.x-mpy-2022XXXX" folder** in your file explorer or Finder 
...
* adafruit_vcnl4040.mpy file path location: C:\Users\...\circuit_python\adafruit-circuitpython-bundle-7.x-mpy-20220216\lib\adafruit_vcnl4040.mpy
* neopixel.mpy file path location: C:\Users\...\circuit_python\adafruit-circuitpython-bundle-7.x-mpy-20220216\lib\neopixel.mpy
...
<iframe width="1120" height="630" src="https://www.youtube.com/embed/FWilOIX0rbg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
