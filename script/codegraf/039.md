...
- **WARNING:** Image screenshots and videos are consistent only with the date this documented was created on date of publishing this page, but serve as a general reference.
...
3\. **Save** the file **in a secure and accessible location** in your computer. **ALERT:** DO NOT open the file.
...
2\. With a usb cable, **connect** a **type-c** end **to** the **board** labeled 1 in the diagram.
