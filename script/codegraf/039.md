...
<img src="../images/circuit_python_instruction_images_videos/circuit_python_7x_uf2_file.png" title="CircuitPython .UF2 file download screenshot" width="492" length="227" style="border:1px solid black">
...
2\. **copy and paste** the "operating system" (i.e., **.UF2 file**) **into the external drive** (i.e., RPI-RP2) you connected in step 2
...
In this step, we'll install a Python code editor (i.e., [Mu editor](https://codewith.mu/en/about)) 
