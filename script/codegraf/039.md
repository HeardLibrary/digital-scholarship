...
<br/>
## Install modules and library on board
...
3\. **Copy and paste** the two .mpy files (i.e., **adafruit_vcnl4040.mpy and neopixel.mpy**) and the folder (i.e., **fdaf**) **from** the **adafruit-circuitpython-bundle-7.x-mpy-2022XXXX lib sub-folder into** the board (i.e., **CIRCUITPY (D:)**) **lib sub-folder**
...
In this exercise, we'll be writing code that is for for the QT Py board. In particular, we'll be adjusting the LED light by changing the frequency, color, and delay of the QT Py board light.
