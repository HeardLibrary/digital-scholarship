...
- **WARNING:** Image screenshots are consistent only with the date this documented was created on date of publishing this page. As such, their accurary is dependant on  not be entirely relied on but serve as a general reference,
...
1\. **Open [https://circuitpython.org/board/adafruit_qtpy_rp2040/](https://circuitpython.org/board/adafruit_qtpy_rp2040/) link**
...
In this step, we'll be connecting the board to your computer with a usb cable

1\. Connect the QT Py RP2040 board to your computer with a USB cable
* Below there is a diagram of the QT Py RP2040 board with a <span style="color:red">**red**</span> and <span style="color:blue">**blue**</span> square around two buttons. 
	* **remember** where the <span style="color:red">**red**</span> **button** is, also known as the boot button.

<img src="../images/circuit_python_instruction_images_videos/qtpy_boot_button.png" title="QT Py Diagram" style="border:1px solid black" width="719" height="495">

2\. With a usb cable, **connect** a **type-c** end **to** the **board**.
	* **ALERT:** *DO NOT* connect the board to your computer, yet
3\. **While holding onto the** <span style="color:red">**red**</span> **button**, located in the center, **connect** the other end of **the usb cable to your computer**. After connecting to you computer you can stop holding onto the red button.
...
<iframe width="1120" height="630" src="https://www.youtube.com/embed/pW_SIuu046k" title="board recognized as external drive" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
1\. Open your file explorer and locate where the .UF2 file you downloaded in Step 1 is  

2\. **copy and paste** or *drag and drop* the "operating system" (i.e., **.UF2 file**) **into the external drive** (i.e., RPI-RP2) you connected in step 2
* *Notice:* if you need help finding where these two are ask someone for help
* if **done successfully**, the **external drive** is **renamed** to **"CIRCUITPY"** Ignore the files seen in the external drive within the video. What matters is having the external drive renamed to CIRCUITPY 

<iframe width="1120" height="630" src="https://www.youtube.com/embed/bHKfWWH6HLU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>


## Install the Mu code editor

In this step, we'll install a Python code editor (i.e., [Mu editor](https://codewith.mu/en/about)) and the [Circuit Python Library Bundle](https://circuitpython.org/libraries)
...
3\. Navigate to the location of the Mu Editor in your File Explorer and proceed to **install** the **Mu Editor**, this might take a few minutes (e.g., ~5 min). If the editor doesnt open in 5 min, ask for help.

4\. Once the Mu Editor launches **set** the **mode to "Circuit Python."**
...
4\. Navigate to the location of the "CircuitPython-bundle-7.x.x" and **unzip** (i.e., "extract all") the **"CircuitPython-bubdle-7.x.x"** folder
...
In this step, we'll "install" Modules from the CircuitPython Library Bundle into our CIRCUITPY External Drive board

1\. After you finish unziping/extracting there are 2 .mpy files (i.e., adafruit_vcnl4040.mpy and neopixel.mpy) we will copy and paste, or drag and drop into the board (i.e., CIRCUITPY external drive in your File Explorer)
...
2\. **Open** the **"adafruit-circuitpython-bundle-7.x-mpy-2022XXXX" folder** in your file explorer and navigate to the "lib" folder within. In there, you'll find the two .mpy files (i.e., adafruit_vcnl4040.mpy and neopixel.mpy)
...
3\. **copy and paste** or *drag and drop* the modules (i.e., **adafruit_vcnl4040.mpy and neopixel.mpy**) **in** the **lib folder into** the board (i.e., **CIRCUITPY (D:)**)
...
In this step, we'll connect a sensor (i.e., Adafruit VCNL 4040) with a stemma QT cable (i.e., JST SH 4-Pin Cable 50mm long) to our QT Py RP2040 board
