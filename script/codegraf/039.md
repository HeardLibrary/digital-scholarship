...
*  *Notice*: if you are on a Windows device you'll need to **unzip** (i.e., "extract all") the **"CircuitPython-bubdle-7.x.x"** folder. If you are unfamiliar with "unzping" folder please ask for assistance. We are more than happy to help. Mac users, you don't need to unzip the folder, it's already done for you.
