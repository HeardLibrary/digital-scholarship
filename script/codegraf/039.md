...
In this exercise, we'll be writing code that is for for the QT Py board. In particular, we'll be adjusting the LED light by hanging the frequency, color, and delay of the QT Py board light.
...
1\. Within the Mu Editor, press upload, navigate to the CIRCUITPY drive, and upload the code.py file.
