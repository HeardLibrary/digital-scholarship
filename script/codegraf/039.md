...
1\. **Open** the **"adafruit-circuitpython-bundle-7.x-mpy-2022XXXX" folder** in your file explorer or Finder and navigate to the "lib" folder within. In there, you'll find the two .mpy files (i.e., "adafruit_vcnl4040.mpy" and "neopixel.mpy")
...
3\. **copy and paste** the two .mpy files (i.e., **adafruit_vcnl4040.mpy and neopixel.mpy**) **in** the **lib folder into** the board (i.e., **CIRCUITPY (D:)**)
