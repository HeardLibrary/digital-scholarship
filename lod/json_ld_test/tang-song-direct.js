...
function setProvinceOptions(isoLanguage) {
	...
	var encodedQuery = encodeURIComponent(string);
        ...
        $.ajax({
            type: 'GET',
            url: 'https://5j6diw4i0h.execute-api.us-east-1.amazonaws.com/sparql?query=' + encodedQuery,
            headers: {
...
//			var category = $('#box4').val();
			...
			$.ajax({
			    type: 'GET',
			    url: 'https://5j6diw4i0h.execute-api.us-east-1.amazonaws.com/sparql?query=' + encoded,
			    headers: {
				Accept: 'application/sparql-results+xml'
			    },
			    success: parseXml
