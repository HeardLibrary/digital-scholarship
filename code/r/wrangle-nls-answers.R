...
bmi_tibble <- inner_raw %>%
  ...
  mutate(H4TO1 = replace(H4TO1, H4TO1>=6, NA)) %>% # age missing value 6-8
  mutate(H4TO2 = replace(H4TO2, H4TO2>=96, NA)) %>% # age missing value 96-98
  mutate(H4TO3 = replace(H4TO3, H4TO3>=6, NA)) %>% # age missing value 6-8
  mutate(H4TO4 = replace(H4TO4, H4TO4>=96, NA)) %>% # age missing values 96-98
  mutate(H4TO5 = replace(H4TO5, H4TO5>=32, NA)) %>% # days/month missing values greater than 31
