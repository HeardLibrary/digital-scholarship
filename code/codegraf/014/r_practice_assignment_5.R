...
# Problem 2. Create a new column in the table called "Pacific Islanders" and populate it with a 
# value of "present" if there is a number in the "Native Hawaiian or Other Pacific Islander" column 
# and with a value of "absent" if there is a missing value. Remember that when a column header
# contains a space, you must surround its name with backticks (`), which are different from 
# single quotes (').


# Problem 3. Sort the resulting tibble from the school with the most students to the 
# school with the least.


# Problem 4. Use the select() function to create a new data frame that contains only the School Level, 
# School Name, total number of students, and Pacific Islanders columns.


# Problem 5. Combine steps 1-4 in the previous problems into a single pipeline using 
...
# Problem 6. For each row where the School Level column has a value of "Elementary School", 
# replace "Elementary School" with "Primary School".
